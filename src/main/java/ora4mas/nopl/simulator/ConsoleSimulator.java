...
public class ConsoleSimulator {
    ...
    static void runWritePaper(WorkspaceKernel ora4masKernel, ICartagoContext ora4masCxt) throws Exception {
        ora4masKernel.makeArtifact(ora4masCxt.getAgentId(), "g1",   GroupBoard.class.getName(),  new ArtifactConfig("C:/organization/moise/write_paper.xml", "wpgroup"));
        ora4masKernel.makeArtifact(ora4masCxt.getAgentId(), "sch1", SchemeBoard.class.getName(), new ArtifactConfig("C:/organization/moise/write_paper.xml", "writePaperSch"));
